...
export default function WelcomeNotificationModal({ 
  ...
  const tabs = [
    { id: "refund" as TabType, label: "Refund", icon: <RefreshCw size={14} /> },
    { id: "ketentuan" as TabType, label: "Ketentuan", icon: <BookOpen size={14} /> },
    { id: "tutorial" as TabType, label: "Tutorial", icon: <Lightbulb size={14} /> },
  ];
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-[#0f172a] border border-slate-700 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 p-1.5 text-slate-400 hover:text-white hover:bg-slate-700 rounded-full transition-colors z-10"
        >
          <X size={16} />
        </button>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-white font-semibold text-sm">Tutorial dan Informasi</h2>
          </div>
          <div className="flex items-center gap-1.5 px-2 py-1 bg-slate-800 rounded-full border border-slate-600 mr-6">
    ...
    <div className="space-y-3">
      ...
      <div className="bg-slate-800/50 rounded-2xl p-3 border border-slate-700">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-white font-semibold text-xs">Refund Otomatis</h3>
        </div>
      ...
      <div className="bg-slate-800/50 rounded-2xl p-3 border border-slate-700">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-white font-semibold text-xs">Refund Admin</h3>
        </div>
    ...
    <div className="space-y-3">
      <div className="bg-slate-800/50 rounded-2xl p-3 border border-slate-700">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-white font-semibold text-xs">Syarat dan Ketentuan</h3>
        </div>
    ...
    <div className="space-y-3">
      <div className="bg-slate-800/50 rounded-2xl p-3 border border-slate-700">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-white font-semibold text-xs">Cara Menggunakan</h3>
        </div>
